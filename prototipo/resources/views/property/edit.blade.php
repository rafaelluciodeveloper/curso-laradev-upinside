    ...
    <div class="container my-3">
        ...
        <form action="<?= url('/imoveis/update', ['id' => $property->id]); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="rental_price" id="rental_prince" value="<?= $property->rental_price ?>" class="form-control">
            </div>
            <div class="form-group">
            ...
            <input type="submit" value="Atualizar Imovel" class="btn btn-primary"/>
